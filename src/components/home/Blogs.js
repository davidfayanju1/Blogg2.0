  ...
  return (
    <section className='dark:bg-slate-900 dark:text-white bg-gray-50 min-w-[22.6rem] min-h-[100vh] '>
      ...
      <div className="flex-container flex items-start justify-between flex-col-reverse md:flex-row md:min-w-[27rem]">
        ...
        {/* topics */}
        <div className="blog-topics h-full self-start md:sticky top-[10rem] md:w-[43%] w-[100%] min-w-[18rem] min-h-[10rem] border-gray-400 border-b-[.08rem] md:border-none md:py-[4rem] py-[2rem] px-[1rem]">
          ...
          <div className="blog_topic_button_flex md:w-[75%] w-[100%] min-w-[16rem]  flex flex-wrap min-h-[4.76rem]">
