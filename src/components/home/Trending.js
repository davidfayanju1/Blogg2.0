...
const Trending = () => {
    ...
    return (
    <div className='min-h-[40vh] w-full lg:px-[6rem] bg-gray-50 lg:py-[6rem] px-[1.2rem] py-[4rem] dark:bg-slate-800 dark:text-white border-b-[.09rem] border-gray-300'>
        <div className="container mx-auto w-full">
            ...
            <section className='flex md:flex-row flex-col flex-wrap w-full items-center justify-center'>
                {
                    trending && trending.map((trendItem, index) => (

                        <div className="trending-card flex items-start md:mb-[4rem] md:mr-[4rem] mb-[3rem] md:w-[20rem] w-full" key={ index }>
