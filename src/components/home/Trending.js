...
const Trending = () => {
    ...
    return (
    <div className='min-h-[40vh] w-full lg:px-[11rem] bg-gray-50 lg:py-[6rem] px-[1.2rem] py-[4rem] dark:bg-slate-800 dark:text-white'>
            ...
            <section className='flex md:flex-row flex-col flex-wrap'>
                {
                    trending && trending.map((trendItem, index) => (
                        ...
                        <div className="trending-card flex items-start mb-[2rem] md:mr-[4rem]" key={trendItem.uid}>
