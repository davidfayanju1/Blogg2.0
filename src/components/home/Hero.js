...
const Hero = () => {
  return (
    <div className='w-full min-h-[40vh] bg-red-[500] mt-[4.5rem] dark:bg-slate-900 dark:text-white bg-gray-50 lg:px-[4.75rem] lg:py-[8rem] px-[1.2rem] py-[6rem] border-b-[.01rem]'>
