    ...
    <main className='main-article min-h-[100vh] md:px-[7rem] md:py-[4rem] px-[2rem] py-[3rem] w-[100%] dark:text-white md:border-solid border-r border-gray-300 border-none'>
      {
        ...
        blogItems.map((blog) => (
          <div key={ blog.id }>    
            ...
            <div className={`blog-icons-section ${ stuck ? 'w-[8.2rem] h-[2.8rem] rounded-[22px] text-center mx-[auto]' : 'w-[100%]'} flex justify-between dark:text-white text-gray-700 text-[1.65rem] sticky bottom-[-1px] bg-gray-50 dark:bg-slate-900`} ref={ ref }>
